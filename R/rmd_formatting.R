...
#'   \item \code{rmd_italic()}:         between \code{_} and \code{_} as italic;
#'   \item \code{rmd_bold_italic()}:    between \code{**_} and \code{_**}as bold italic;
#'   \item \code{rmd_bold2()}:          between \code{__} and \code{__} as bold;
#'   \item \code{rmd_italic2()}:        between \code{*} and \code{*} as italic;
...
#' @rdname format_rmd
#' @export
rmd_r_code_inline <- function() {
    rs_enclose_selection_with(symbol_before = "`r ", symbol_after = "`")
}

#' @rdname format_rmd
#' @export
rmd_superscript <- function() {
    rs_enclose_selection_with(symbol = "^")
}

#' @rdname format_rmd
#' @export
rmd_subscript <- function() {
    rs_enclose_selection_with(symbol = "~")
}

#' @rdname format_rmd
#' @export
rmd_strikethrough <- function() {
    rs_enclose_selection_with(symbol = "~~")
}
