...
<font color = "red">The development of `spAddins` **ended** in 2018 </font> as the package <font color = "red">RETIRED</font> in favor of packages `addins.rmd` and `addins.rs`.
Please find the development versions of these packages at:
...
are designed to be used in combination with user-defined RStudio keyboard shortcuts. 
These addins either:
