...
|-------------------------|:--------------------------------:|:--------------------------:|
| rs\_insert\_ss\_line()  | Insert single straight (SS) line | `----------`               |
| rs\_insert\_ds\_line()  | Insert double straight (DS) line | `==========`               |
| rs\_insert\_sw\_line()  | Insert single wavy (SW) line     | `~~~~~~~~~~`               | 
...
|-------------------------------|------------------------|:----------------:|:---------------:|
| Replace \`\\\` with \` \\\\\` | rs\_replace\_backslash\_with\_forwasdslash()   | c:\\data\\      | c:\\\\data\\\\  |
| Replace \`\\\` with \` /\`    | rs\_replace\_single\_with\_double\_backslash() | c:\\data\\      | c:/data/        |
| Replace \` /\` with \`\\\`    | rs\_replace\_double\_with\_single\_backslash() | c:\\\\data\\\\  | c:\\data\\      |
...
To call the functions with keyboard shortcuts in *RStudio* explore 
[this article](https://rstudio.github.io/rstudioaddins/#keyboard-shorcuts).
